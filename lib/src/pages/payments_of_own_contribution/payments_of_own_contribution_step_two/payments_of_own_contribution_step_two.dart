...
import 'package:scb_app/src/dialogs/code_alert_dialog.dart';

import '../../../theme/app_theme.dart';
import '../../../widget/button_app.dart';
import '../../../widget/spacer_widget.dart';

class PaymentsOfOwnContributionStepTwoPage extends StatefulWidget {
  const PaymentsOfOwnContributionStepTwoPage({super.key});

  @override
  State<PaymentsOfOwnContributionStepTwoPage> createState() => _PaymentsOfOwnContributionStepTwoPageState();
}

class _PaymentsOfOwnContributionStepTwoPageState extends State<PaymentsOfOwnContributionStepTwoPage> {
