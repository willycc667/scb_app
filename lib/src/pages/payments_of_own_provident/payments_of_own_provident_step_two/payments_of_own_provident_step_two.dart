...
class PaymentsOfOwnProvidentStepTwoPage extends StatefulWidget {
  const PaymentsOfOwnProvidentStepTwoPage({super.key});

  @override
  State<PaymentsOfOwnProvidentStepTwoPage> createState() => _PaymentsOfOwnProvidentStepTwoPageState();
}

class _PaymentsOfOwnProvidentStepTwoPageState extends State<PaymentsOfOwnProvidentStepTwoPage> {
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (_) => CodeAlertDialog(
                      ...
                      buttonText: "",
                      onPressed: () {
                        Navigator.pushNamed(context, 'payments_of_own_provident_step_three', arguments: "");
                      },
                    ),
                  );
                },
