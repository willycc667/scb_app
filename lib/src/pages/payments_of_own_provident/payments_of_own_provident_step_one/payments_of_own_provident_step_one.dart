...
class PaymentsOfOwnProvidentStepOnePage extends StatefulWidget {
  const PaymentsOfOwnProvidentStepOnePage({super.key});

  @override
  State<PaymentsOfOwnProvidentStepOnePage> createState() => _PaymentsOfOwnProvidentStepOnePageState();
}

class _PaymentsOfOwnProvidentStepOnePageState extends State<PaymentsOfOwnProvidentStepOnePage> {
          ...
          child: Column(
            ...
            children: [
              ...
              ButtonApp(
                ...
                text: 'Continuar',
                onPressed: () {
                  Navigator.pushNamed(context, 'payments_of_own_provident_step_two', arguments: "");
                },
              ),
              const SpacerWidget(),
            ],
