...
class PaymentsOfThirdPartyCreditStepThreePage extends StatefulWidget {
  const PaymentsOfThirdPartyCreditStepThreePage({super.key});

  @override
  State<PaymentsOfThirdPartyCreditStepThreePage> createState() => _PaymentsOfThirdPartyCreditStepThreePageState();
}

class _PaymentsOfThirdPartyCreditStepThreePageState extends State<PaymentsOfThirdPartyCreditStepThreePage> {
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (_) => CodeAlertDialog(
                      ...
                      buttonText: "",
                      onPressed: () {
                        Navigator.pushNamed(context, 'payments_of_own_credit_step_three', arguments: "");
                      },
                    ),
                  );
                },
