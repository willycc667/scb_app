...
class PaymentsOfThirdPartyProvidentStepTwoPage extends StatefulWidget {
  const PaymentsOfThirdPartyProvidentStepTwoPage({super.key});

  @override
  State<PaymentsOfThirdPartyProvidentStepTwoPage> createState() => _PaymentsOfThirdPartyProvidentStepTwoPageState();
}

class _PaymentsOfThirdPartyProvidentStepTwoPageState extends State<PaymentsOfThirdPartyProvidentStepTwoPage> {
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (_) => CodeAlertDialog(
                      ...
                      buttonText: "",
                      onPressed: () {
                        Navigator.pushNamed(context, 'payments_of_third_party_provident_step_three', arguments: "");
                      },
                    ),
                  );
                },
